...
if(hit.next().hasClass("tree-folder-closed-mini")){
hit.next().removeClass("tree-folder-closed-mini").addClass("tree-folder-open-mini");
}else{
hit.next().removeClass("tree-folder-closed").addClass("tree-folder-open");
}
if(hit.next().next().hasClass("tree-title-mini-closed")){
hit.next().next().removeClass("tree-title-mini-closed").addClass("tree-title-mini");
}
var ul=$(_135).next();
if(ul.length){
if(opts.animate){
...
if(hit.next().hasClass("tree-folder-open-mini")){
hit.next().removeClass("tree-folder-open tree-folder-open-mini").addClass("tree-folder-closed-mini");
}else{
	hit.next().removeClass("tree-folder-open").addClass("tree-folder-closed");
}
if(hit.next().next().hasClass("tree-title-mini")){
hit.next().next().removeClass("tree-title-mini").addClass("tree-title-mini-closed");
}
var ul=$(_13a).next();
if(opts.animate){
...
item.domId="_easyui_tree_"+_1b3_1;
cc.push("<li>");
if(item.children&&item.children.length){
	if(item.children&&item.children.length){
	  cc.push("<div id=\""+item.domId+"\" class=\"tree-node\" >");
	}else{
    cc.push("<div id=\""+item.domId+"\" class=\"tree-node\" style=\"width:279px;height:28px;white-space:nowrap;cursor: pointer;\">");
  }
}else{
  cc.push("<div id=\""+item.domId+"\" class=\"tree-node\" style=\"width:279px;height:28px;white-space:nowrap;cursor: pointer;\">");
}
...
if(item.children&&item.children.length){
    if(item.children.children&&item.children.children.length){
      cc.push("<span class=\"tree-hit tree-expanded-mini\"></span>");
      cc.push("<span class=\"tree-icon tree-folder tree-folder-open-mini "+(item.iconCls?item.iconCls:"")+"\"></span>");
    }else{
...
if(_1b3_1==zhanghj1){
cc.push("<span class=\"tree-title-mini\">"+opts.formatter.call(_1b5,item)+"</span>");
}else if(_1b3_1>zhanghj1){
cc.push("<span class=\"tree-title-end\">"+opts.formatter.call(_1b5,item)+"</span>");
}else{
...
hit.removeClass("tree-collapsed tree-collapsed-hover").addClass("tree-expanded");
hit.next().removeClass("tree-folder-closed tree-folder-closed-mini").addClass("tree-folder-open");
if(hit.next().next().hasClass("tree-title-mini-closed")){
hit.next().next().removeClass("tree-title-mini-closed").addClass("tree-title-mini");
}
