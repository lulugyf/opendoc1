...
function MzTreeView(Tname)
{
  ...
  this.toString = function()
  {
    ...
    var str = "<A id='"+ this.name +"_RootLink' href='#' style='DISPLAY: none; color:#003399'></A>";
...
MzTreeView.prototype.nodeClick = function(id)
{
  ...
  //alert(id);
  //alert(source);
  //L(true,"1100","test","wuln_test/frameset.html","000");
