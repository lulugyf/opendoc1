...
function doSrchSubmit(){
    document.forms['srchFrm'].action="<%=request.getContextPath()%>/npage/host/host/host_list.jsp"+param;
...
function addM(){
	...
	openDivWin("<%=request.getContextPath()%>/gotoAddHost.do"+qryPara,"新增主机","800","350");
	refreshByClose();
}
//list页面弹出窗口的关闭事件执行
