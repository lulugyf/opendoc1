...
function doSrchSubmit(){
    document.forms['srchFrm'].action="<%=request.getContextPath()%>/npage/host/user/hostuser_list.jsp"+param;
...
function addM(){
	...
	openDivWin("<%=request.getContextPath()%>/gotoAddHostUser.do"+qryPara,"新增主机用户","800","400");
	refreshByClose();
}
//list页面弹出窗口的关闭事件执行
