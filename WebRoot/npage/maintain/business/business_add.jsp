		...
		<form action="" method="post" name="hostForm">
			...
			<div class="input">
				<table>
					...
					<tr>
						<th><font color="red">*业务功能名称：</font></th>
						<td>
			...
			<div id="operation_button">
				<input type="button" name="su" onClick="addBusiness()" class="b_foot" value="确定" />
...
function addBusiness(){
	...
	document.hostForm.action='<%=request.getContextPath()%>/addBusiness.do';
