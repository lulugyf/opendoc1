...
<div class="title"> <div class="text">业务明细列表</div></div>  
<div class="list">
	<table id="mTable">
		<tr>
			<th>交易处理时间</th>
...
function showXml(transXml){
	...
	parent.openDivWin("<%=request.getContextPath()%>/npage/maintain/business_data/businessdata_detailXml.jsp?transXml="+transXml,"交易报文","800","400");
}
</script>
	...
	function dataWrite(tableID,iStartPos,retNum){
	   ...
	   for(var i=0;i<len;i++){
    	...
    	for(var i=0; i<retNum; i++){ 
			...
			arrTd[7].innerHTML='<a style="text-decoration:underline" href="#this" onclick="showXml(\''+arrPage[iStartPos+i][7]+'\')">报文</a>';
		}
	}
