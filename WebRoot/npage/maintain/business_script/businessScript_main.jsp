...
<div id="operation">
	<form name="srchFrm" target="ifm" method=post>
	    ...
	    <div id="operation_table">			
			...
			<iframe name="ifm" src="" style="width:100%;height:450px;" frameborder="0"></iframe>
...
function doSrchSubmit(){
    document.forms['srchFrm'].action="<%=request.getContextPath()%>/npage/maintain/business_script/businessScript_list.jsp"+param;
...
function addM(){
	...
	openDivWin("<%=request.getContextPath()%>/gotoAddBusinessScript.do?"+qryPara,"新增业务脚本配置","800","400");
	refreshByClose();
}
//list页面弹出窗口的关闭事件执行
