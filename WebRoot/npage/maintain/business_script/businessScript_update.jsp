	...
	<div id="operation_table">
		<form action="" method="post" name="hostForm">
			...
			<div id="operation_button">
				<input type="button" name="su" onClick="updateBusinessScript()" class="b_foot" value="确定" />
...
function updateBusinessScript(){
	...
	document.hostForm.action='<%=request.getContextPath()%>/updateBusinessScript.do';
