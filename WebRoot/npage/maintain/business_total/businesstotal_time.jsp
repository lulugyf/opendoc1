...
<div class="title"> <div class="text">交易时长汇总统计</div></div>  
<div class="list">
	<table id="mTable">
		<tr>
			<th>交易统计时间</th>
	...
	function dataWrite(tableID,iStartPos,retNum){
	   ...
	   for(var i=0;i<len;i++){
    	...
    	for(var i=0; i<retNum; i++){ 
			...
			arrTd[6].innerHTML='<a style="text-decoration:underline" href="#this" onclick="showXml(\''+arrPage[iStartPos+i][7]+'\')">'+
				arrPage[iStartPos+i][6]+'</a>';
		}
	}
