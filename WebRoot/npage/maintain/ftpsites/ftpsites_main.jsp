...
function doSrchSubmit(){
    document.forms['srchFrm'].action="<%=request.getContextPath()%>/npage/maintain/ftpsites/ftpsites_list.jsp"+param;
...
function addM(){
	...
	openDivWin("<%=request.getContextPath()%>/gotoAddFtpsite.do"+qryPara,"新增FTP站点","750","400");
	refreshByClose();
}
//list页面弹出窗口的关闭事件执行
