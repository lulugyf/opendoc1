...
String scriptsId=request.getParameter("scriptsId");
   ...
   <div id="operation">
	<div id="operation_table">
		<form action="" method="post" name="hostForm">
			...
			<input type=hidden name="scriptsId" id="scriptsId" value="<%=scriptsId%>">	
...
function updateWorkOrderScript(){
	...
	document.hostForm.action='<%=request.getContextPath()%>/updateHostCheckScript.do';
