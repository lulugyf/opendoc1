...
%>
 ...
 <%
  ...
  if(request.getAttribute("qryRsrPro_File_Path") != null){
	 ScriptsDir = request.getAttribute("qryRsrPro_File_Path").toString();
 	}
 	
 	
  if(request.getAttribute("qryRsrPro_File_Name") != null){
	 ScriptsName =ScriptsDir+"/"+request.getAttribute("qryRsrPro_File_Name").toString();
 	}
