				...
				<table>
					<tr>
						...
						<td>
							...
							<input type=hidden name="tellType" id="tellType">
...
function doSrchSubmit(){
    document.forms['srchFrm'].action="<%=request.getContextPath()%>/npage/maintain/progress/progress_list.jsp"+param;
...
function addM(){
	...
	openDivWin("<%=request.getContextPath()%>/gotoAddAppProgConf.do?"+qryPara,"新增应用进程配置","800","400");
	refreshByClose();
}
//list页面弹出窗口的关闭事件执行
