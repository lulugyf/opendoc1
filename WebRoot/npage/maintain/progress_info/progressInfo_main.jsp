...
function doSrchSubmit(){
    document.forms['srchFrm'].action="<%=request.getContextPath()%>/npage/maintain/progress_info/progressInfo_list.jsp"+param;
...
function addM(){
	...
	openDivWin("<%=request.getContextPath()%>/gotoAddProgInfoConf.do"+qryPara,"新增进程信息配置","800","400");
	refreshByClose();
}
//list页面弹出窗口的关闭事件执行
