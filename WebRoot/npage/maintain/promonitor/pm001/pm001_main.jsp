...
function doSrchSubmit(){
	...
	if(busiIdentify != ""){	
    	document.forms['proMonitorForm'].action="<%=request.getContextPath()%>/npage/maintain/promonitor/pm001/pm001_list_"+busiIdentify+".jsp" + param +"&busiIdentify=" + busiIdentify;
...
function addM(){
	...
	openDivWin("<%=request.getContextPath()%>/npage/maintain/promonitor/pm001/pm001_add.jsp" + qryPara, "新增进程信息", "800", "400");
	refreshByClose();
}
