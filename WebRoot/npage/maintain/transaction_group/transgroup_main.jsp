...
function doSrchSubmit(){
    document.forms['srchFrm'].action="<%=request.getContextPath()%>/npage/maintain/transaction_group/transgroup_list.jsp"+param;
...
function addM(){
	...
	openDivWin("<%=request.getContextPath()%>/gotoAddTransGroup.do"+qryPara,"新增分组配置","800","400");
	refreshByClose();
}
//list页面弹出窗口的关闭事件执行
