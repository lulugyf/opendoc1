	...
	<div id="operation_table">
		<form action="" method="post" name="hostForm">
			...
			<div id="operation_button">
				<input type="button" name="su" onClick="addWorkOrderScript()" class="b_foot" value="确定" />
...
function addWorkOrderScript(){
	...
	document.hostForm.action='<%=request.getContextPath()%>/addWorkOrderScript.do';
...
function choiceItemInfo(){
	...
	openDivWin("<%=request.getContextPath()%>/getItemInfoList.do?"+qryPara,"查询进程信息","700","300");
}
