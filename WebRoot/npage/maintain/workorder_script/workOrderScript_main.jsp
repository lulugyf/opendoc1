...
function doSrchSubmit(){
    document.forms['srchFrm'].action="<%=request.getContextPath()%>/npage/maintain/workorder_script/workOrderScript_list.jsp"+param;
...
function addM(){
	...
	openDivWin("<%=request.getContextPath()%>/gotoAddWorkOrderScript.do?"+qryPara,"新增工单脚本配置","800","400");
	refreshByClose();
}
//list页面弹出窗口的关闭事件执行
