			...
			<div class="input">
				<table>
					<tr>
						...
						<td>
							<input type="text" name="proName" id="proName"  value="${romProCode.proName}" class="required isCharLengthOf" v_maxlength="64" v_minlength="0"/>
						</td>
						<th><font color="red">*产品版本：</font></th>
						<td>
							<input type="text" name="proVersion" id="proVersion"  value="${romProCode.proVersion}" class="required isCharLengthOf" v_maxlength="10" v_minlength="0"/>
						</td>				
					</tr>
					<tr>
						<th>备注：</th>
						<td colspan="3">
							<input type="text" name="remarks" id="remarks"  value="${romProCode.remarks}" class="isCharLengthOf" v_maxlength="256" v_minlength="0" size="100"/>
						</td> 				
					</tr>										
				</table>
			</div>
			<div id="operation_button">
				<input type="button" name="su" onClick="updateProductSubmit()" class="b_foot" value="确定" />
