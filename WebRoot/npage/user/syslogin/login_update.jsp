		...
		<input type=hidden name="proId" id="proId" value="<%=proId%>">
		 <c:if test="${updateObj.loginNo!=null}"> 
				...
				<table>
					<tr>
						...
						<td>
							...
							<input type="text" name="loginNo" id="loginNo" value="${updateObj.loginNo}" class="required isCharLengthOf numOrLetter" v_maxlength="8" v_minlength="0"/>
						</td>
						<th><font color="red">*姓名</font></th>
						<td>
							<input type="text" name="loginName" id="loginName" value="${updateObj.loginName}" class="required isCharLengthOf" v_maxlength="64" v_minlength="0"/>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="text" name="phoneNo" id="phoneNo" value="${updateObj.phoneNo}" class="required isLengthOf allCellPhone" v_maxlength="15" v_minlength="0"/>
						</td>
					</tr>
			...
			<div id="operation_button">
				<input type="button" name="su" id="su" onclick="updateLoginSubmit()" class="b_foot" value="确定" />
				<input type="reset" name="re" id="re" onclick="javascript:document.forms('loginForm').reset();" class="b_foot" value="重置" />
